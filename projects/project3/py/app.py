...
def webhook():
   ...
   Hier ist der vollständige `app.py` Code mit der hinzugefügten Logik für das Jahr 2024 und den entsprechenden Anpassungen für die Antwortformatierung. Du kannst diesen Code direkt in deine Datei einfügen.
